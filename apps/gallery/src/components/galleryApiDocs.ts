...
export const galleryApiDocs: Record<string, GalleryApiItem[]> = {
  ...
  "/components/text": [
    ...
    { name: "size", type: '"xs" | "sm" | "md" | "lg" | "xl" | "2xl"', default: '"md"', description: "Text size token." },
    { name: "weight", type: '"regular" | "medium" | "semibold" | "bold"', default: '"regular"', description: "Font weight token." },
    { name: "color", type: "Color", default: '"text-color-regular"', description: "Text color token or semantic color." },
    { name: "gradient", type: "boolean", default: "false", description: "Uses a gradient fill clipped to text." },
    { name: "highlight", type: "boolean", default: "false", description: "Adds a soft highlighted background." },
    { name: "ellipsis", type: "boolean | number", default: "false", description: "Single-line or multi-line truncation." },
    slotDefault,
  ],
  "/components/picture": [
