...
export const galleryApiDocs: Record<string, GalleryApiItem[]> = {
  ...
  "/components/input": [
    ...
    { name: "password", type: "boolean", default: "false", description: "InputText only. Toggles password visibility support." },
  ...
  "/components/combobox": [
    ...
    { name: "clearable", type: "boolean", default: "true", description: "Shows the input clear action and resets Combobox value when empty." },
  ...
  "/components/date-time": [
    ...
    { name: "clearable", type: "boolean", default: "true", description: "Shows a clear action when a value exists." },
    colorProp,
    sizeProp,
    disabledProp,
    invalidProp,
