...
const componentSidebarGroups = computed(() => [
  ...
  },
  {
    ...
    pages: [
      ...
      { label: t("gallery.sidebar.separator"), description: "Separator", link: "/components/separator" },
      { label: t("gallery.sidebar.flex"), description: "Flex", link: "/components/flex" },
      { label: t("gallery.sidebar.affix"), description: "Affix", link: "/components/affix" },
  ...
  },
  {
    ...
    pages: [
      ...
      { label: t("gallery.sidebar.text"), description: "Text", link: "/components/text" },
      { label: t("gallery.sidebar.gradientText"), description: "GradientText", link: "/components/gradient-text" },
      { label: t("gallery.sidebar.highlightText"), description: "HighlightText", link: "/components/highlight-text" },
      { label: t("gallery.sidebar.picture"), description: "Picture", link: "/components/picture" },
      { label: t("gallery.sidebar.carousel"), description: "Carousel", link: "/components/carousel" },
      { label: t("gallery.sidebar.countdown"), description: "Countdown", link: "/components/countdown" },
