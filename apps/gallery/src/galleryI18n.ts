...
const zh = {
  ...
  componentMeta: {
    ...
    text: "提供基础文本、语义颜色、内联修饰和截断能力。",
    gradientText: "用渐变填充短标题或重点词，不改变基础文本组件的职责。",
    highlightText: "用柔和背景标记关键词和短语，适合正文中的轻量强调。",
    picture: "展示图片并提供加载失败兜底与预览能力。",
    carousel: "在有限空间中轮播图片、内容卡片或状态面板。",
    countdown: "展示距离目标时间或固定时长的倒计时。",
...
const en: typeof zh = {
  ...
  componentMeta: {
    ...
    text: "Provides base text, semantic tone, inline treatments, and truncation behavior.",
    gradientText: "Applies a gradient fill to short headings or emphasized words without expanding the base Text component.",
    highlightText: "Marks keywords and short phrases with a soft background for lightweight inline emphasis.",
    picture: "Displays images with fallback and preview behavior.",
    carousel: "Cycles images, content cards, or status panels inside a constrained area.",
    countdown: "Displays remaining time toward a target timestamp or fixed duration.",
