...
<template>
  <ol
    ...
    :style="{
      ...
      '--mcsl-steps__color-soft': new ColorData(color, 'default', 0.14).getCss(),
    }"
  >
    <li
...
.mcsl-steps__item:not(:last-child)::after {
  content: "";
  position: absolute;
  top: calc((var(--mcsl-steps__indicator-size) - var(--mcsl-steps__track-size)) / 2);
...
.mcsl-steps--vertical .mcsl-steps__item:not(:last-child)::after {
  ...
  left: calc((var(--mcsl-steps__indicator-size) - var(--mcsl-steps__track-size)) / 2);
  right: auto;
...
.mcsl-steps__indicator {
  ...
  border: 1px solid color-mix(in srgb, var(--mcsl-border-color-base) 84%, transparent);
  border-radius: 999px;
  background:
    linear-gradient(
      180deg,
...
.mcsl-steps__item--finish {
  &::after {
    background: color-mix(in srgb, var(--mcsl-steps__color) 58%, var(--mcsl-steps__track-color));
  }

  .mcsl-steps__indicator {
    border-color: color-mix(in srgb, var(--mcsl-steps__color) 42%, var(--mcsl-border-color-base));
    background:
      linear-gradient(
        180deg,
...
.mcsl-steps__item--error {
  &::after {
    background: color-mix(in srgb, var(--mcsl-color-danger) 34%, var(--mcsl-steps__track-color));
  }

  .mcsl-steps__indicator {
    border-color: color-mix(in srgb, var(--mcsl-color-danger) 52%, var(--mcsl-border-color-base));
    background:
      linear-gradient(
        180deg,
        color-mix(in srgb, var(--mcsl-color-danger) 13%, var(--mcsl-bg-color-overlay)),
        color-mix(in srgb, var(--mcsl-color-danger) 8%, var(--mcsl-bg-color-overlay))
      );
    color: var(--mcsl-color-danger);
    box-shadow: 0 0 0 4px color-mix(in srgb, var(--mcsl-color-danger) 10%, transparent);
  }
...
.mcsl-steps--clickable .mcsl-steps__button:not(:disabled):hover .mcsl-steps__indicator {
  border-color: color-mix(in srgb, var(--mcsl-steps__color) 48%, var(--mcsl-border-color-base));
  box-shadow:
...
@media (max-width: 640px) {
  ...
  .mcsl-steps:not(.mcsl-steps--vertical) .mcsl-steps__item:not(:last-child)::after {
    top: calc(var(--mcsl-steps__indicator-size) + var(--mcsl-spacing-xs));
    bottom: var(--mcsl-spacing-xs);
    left: calc((var(--mcsl-steps__indicator-size) - var(--mcsl-steps__track-size)) / 2);
    right: auto;
