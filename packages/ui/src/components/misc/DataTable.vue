...
<template>
  <div class="mcsl-data-table" :style="gridStyle" role="table">
    <div class="mcsl-data-table__row mcsl-data-table__row--head" role="row">
      <div v-if="selectable" class="mcsl-data-table__cell mcsl-data-table__cell--select" role="columnheader">
        <button
          type="button"
      ...
      <div v-if="$slots.actions" class="mcsl-data-table__cell mcsl-data-table__cell--head" role="columnheader">
        Actions
      </div>
    </div>
    ...
    <div v-else class="mcsl-data-table__body">
      <div
        ...
        role="row"
      >
        <div v-if="selectable" class="mcsl-data-table__cell mcsl-data-table__cell--select" role="cell">
          <button
            type="button"
            class="mcsl-data-table__check"
            :class="{ 'mcsl-data-table__check--checked': isSelected(row, rowIndex) }"
        ...
        <div v-if="$slots.actions" class="mcsl-data-table__cell mcsl-data-table__cell--actions" role="cell">
